...
_CLASS_KEYWORDS: dict[str, list[str]] = {
    ...
    "cephalopod":  ["octopus", "squid", "cuttlefish", "nautilus", "cephalopod",
                    "blue-ringed"],
    "amphibian":   ["frog", "toad", "salamander", "newt", "axolotl", "mudpuppy",
                    "tadpole", "caecilian", "amphibian"],
    "bird":        ["bird", "eagle", "falcon", "hawk", "owl", "penguin", "toucan",
                    "macaw", "parrot", "flamingo", "peacock", "heron", "stork",
                    "crane", "ostrich", "emu", "kiwi", "puffin", "albatross",
                    "vulture", "condor", "duck", "goose", "swan", "hummingbird",
                    "woodpecker", "kingfisher", "kookaburra", "lorikeet", "cockatoo"],
