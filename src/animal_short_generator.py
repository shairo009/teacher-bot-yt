...
def _upload_to_youtube(video_path: Path, species: dict, dry_run: bool) -> str | None:
    ...
    try:
        ...
        name = species["name"]
        title = species.get("yt_title", f"How to Code an Interactive {name} Cursor in JavaScript ⚡ #Shorts")[:100]
        description = species.get("yt_desc", f"How to code an interactive {name} cursor follow animation in JavaScript canvas with inverse kinematics physics.")
        ...
        tags = [
            ...
            "animal", "biology", "realistic animation", "math", "algorithms"
        ]
